...
public class ValuationPolicyTests {
    ...
    void setUp() throws Exception {
    	...
    	this.bike1 = new Bike(BikeTypes.MOUNTAINBIKE, this.provider.getAddress(), this.provider
    	.getName());
    	*/
    ...
    void testCalculateValue() {
    	/*
    	assertEquals(this.bike1.getType().getReplacementValue(), CalculateValue(this.bike1, this
    	.date1));
    	*/
    }
}
